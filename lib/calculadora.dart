// Suggested code may be subject to a license. Learn more: ~LicenseLog:4025867594.
// Suggested code may be subject to a license. Learn more: ~LicenseLog:3302959040.
// Suggested code may be subject to a license. Learn more: ~LicenseLog:289625716.
...
class _CalculadoraState extends State<Calculadora> {
  ...
  void _pressionarBotao(String valor) {
    setState(() {
      if (valor == _limpar) {
        // Corrigido: Usar o valor da variável _limpar
        _expressao = '';
        _resultado = '';
      } else if (valor == '=') {
        _calcularResultado(); // Habilitado para chamar o método de cálculo
      } else {
        _expressao += valor;
      }
    });
  ...
  void _calcularResultado() {
    try {
      ...
      _resultado = 'Não épossível calcular :';
    }
  }
